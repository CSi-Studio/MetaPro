<template>
  <h1 id="user-manual" tabindex="-1">
    <a class="header-anchor" href="#user-manual" aria-hidden="true">#</a>
    <RouterLink to="/guide/user-manual.html">User Manual</RouterLink>
  </h1>
  <h2 id="framework" tabindex="-1">
    <a class="header-anchor" href="#framework" aria-hidden="true">#</a>
    Framework
  </h2>
  <p><img src="/images/image_33.png" alt="" /></p>
  <hr />
  <h2 id="main-interface" tabindex="-1">
    <a class="header-anchor" href="#main-interface" aria-hidden="true">#</a>
    Main Interface
  </h2>
  <p><img src="/images/Interface.png" alt="" /></p>
  <hr />
  <h2 id="demo" tabindex="-1">
    <a class="header-anchor" href="#demo" aria-hidden="true">#</a> Demo
  </h2>
  <p>
    <a href="http://47.88.77.176" target="_blank" rel="noopener noreferrer"
      ><code>http://47.88.77.176</code><ExternalLinkIcon
    /></a>
  </p>
  <hr />
  <h2 id="download" tabindex="-1">
    <a class="header-anchor" href="#download" aria-hidden="true">#</a> Download
  </h2>
  <h3 id="software" tabindex="-1">
  ...
  <p>
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      >MetaPro v1.1.8<ExternalLinkIcon
    /></a>
  </p>
  <h3 id="test-data-and-libraries" tabindex="-1">
    <a class="header-anchor" href="#test-data-and-libraries" aria-hidden="true"
      >#</a
    >
  ...
  <p>
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      >OneDrive<ExternalLinkIcon
    /></a>
  </p>
  <hr />
  <h2 id="how-to-install" tabindex="-1">
    <a class="header-anchor" href="#how-to-install" aria-hidden="true">#</a> How
    to install
  </h2>
  <blockquote>
  ...
  <h3 id="windows" tabindex="-1">
    <a class="header-anchor" href="#windows" aria-hidden="true">#</a> Windows
  </h3>
  <ul>
    <li>
    ...
    <li>
      ...
      <p>
        ...
        <strong>After successful startup, open a browser and connect to</strong>
        <strong><code>localhost:8080</code></strong>
      </p>
    </li>
    <li>
      <p>
  ...
  <h3 id="macos" tabindex="-1">
    <a class="header-anchor" href="#macos" aria-hidden="true">#</a> MacOs
  </h3>
  <ul>
    <li>
      <p>Open a terminal</p>
...
cd MetaproForMac
    ...
    <li>
      <p>start</p>
      <div class="language-text ext-text line-numbers-mode">
        <pre v-pre class="language-text"><code>bash MetaproStart.sh
</code></pre>
        <div class="line-numbers" aria-hidden="true">
      ...
      <div class="language-bash ext-sh line-numbers-mode">
        <pre
          v-pre
          class="language-bash"
        ><code>$ <span class="token function">bash</span> ./MetaproStart.sh
...
$ child process started successfully, parent exiting
    ...
    <li>
      <p>stop</p>
      <div class="language-text ext-text line-numbers-mode">
        <pre v-pre class="language-text"><code>bash MetaproStop.sh
</code></pre>
        <div class="line-numbers" aria-hidden="true">
          <span class="line-number">1</span><br />
        </div>
  ...
  <h3 id="linux" tabindex="-1">
    <a class="header-anchor" href="#linux" aria-hidden="true">#</a> Linux
  </h3>
  <ul>
    <li>
      <p>Open a terminal</p>
...
$ child process started successfully, parent exiting
  ...
  <hr />
  <h2 id="how-to-use" tabindex="-1">
    <a class="header-anchor" href="#how-to-use" aria-hidden="true">#</a> How to
    use
  </h2>
