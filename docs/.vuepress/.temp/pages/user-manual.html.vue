...
For example:
<code>纯文本 # Thermo file Original: file_name.raw Converted: file_name.aird, file_name.json # SCIEX file Original: file_name.wiff, file_name.wiff.scan Converted: file_name.aird, file_name.json </code></p>
<p><strong>Step 2: File directory arrangement</strong>
...
For example, if we set the data directory as <code>repository=/usr/local/data</code>
The folder structure of different projects needs to be arranged as follows:
<code>纯文本 /usr/local/data ├── project-1 ├── batch-1 ├── converted_file-1.aird ├── converted_file-1.json ├── converted_file-2.aird ├── converted_file-2.json ├── batch-2 ├── converted_file-3.aird ├── converted_file-3.json ├── converted_file-4.aird ├── converted_file-4.json ├── project-2 ├── ... ... </code>
...
<ol>
<li>Enter Project page, click <code>Create Project</code> at the top.
...
<code>Owner</code> and <code>Description</code> are optional, fill in according to the demand.</li>
<li>Click <code>Scan Files</code> to scan all converted Aird format files under the project file
...
You can view the files in different batches by selecting Batch name at the top of this page.</li>
</ol>
...
<img src="/images/image_16.png" alt=""></li>
<li>Compound switch module
<ul>
...
<ol>
<li>Arrow keys: <code>↑</code> <code>↓</code> switch componund； <code>→</code> <code>←</code> switch page</li>
...
<ul>
<li>Click on the &quot;more&quot;, users can <code>Reset integration params</code> and <code>Reset TargetRT</code> of a compound.
Click on <code>Reset TargetRT</code>
<img src="/images/image_18.png" alt="">
Click on <code>Reset integration params</code>
<img src="/images/image_19.png" alt=""></li>
</ul>
</li>
<li>Manual inspection module
The buttons on the top are：<code>Restore</code>, <code>Select All/UnSelect</code>, <code>Manual Integration</code>, <code>Reselect</code>, <code>Submit</code>, <code>Batch Submit</code>
<code>Restore</code>: Restore the current module to its initial status.
<code>Select All/Unselect</code>: View all the sample peaks in this batch/Cancel view all the peaks.
<code>Manual Integration</code>: Enter manual integration mode on the selected peak. You can choose two data points (start, end) to modify the peak shape.
...
<code>Batch Submit</code>: Apply the modified peak RT range to all samples in this batch. Used for integrating multiple peaks on an EIC.
Click on <code>Manual Integration</code>, you can choose two data points to conduct manual integration functions. First left and then right.</li>
<li>Spectrum viewer of <code>MS1</code> and <code>MS2</code>
...
<li>Peak shape batch inspection
...
<img src="/images/image_24.png" alt=""></li>
</ol>
